...
the numerical and analytical methods. It will then calculate and plot the
absolute value of the global errors as a function of time.
'''
...
def errCalculate(x0, v0, t):
    ...
    fileData = np.savetxt('numAbsErrsData.txt', errArr)    
    return errArr
